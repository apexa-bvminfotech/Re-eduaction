                            ...
                            <form action="{{route('course.update',$course->id)}}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="course_name" class="form-control"
                                               placeholder="Add Course" value="{{ $course->course_name }}">
                                    </div>
                                </div>
                                @foreach($course->subCourses as $key => $subCourse)
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="edit_sub_course_name[{{$subCourse->id}}]"
                                                   class="form-control"
                                    ...
                                    @foreach($subCourse->points as $point)
                                        <div class="form-group row clone-points">
                                            ...
                                            <div class="col-sm-5 clone-points">
                                                <input type="text" name="edit_point[{{$subCourse->id}}][{{$point->id}}]"
                                                       data-id="{{$subCourse->id}}" class="form-control point-rmv"
                                                       value="{{$point->sub_point_name}}">
                                            </div>

                                            <div class="col-sm-3">
                                                <button type="button" name="add_point" data-id="{{$subCourse->id}}"
                                                        class="btn btn-primary add-points btn-start">+
                                                </button>
                                            </div>
