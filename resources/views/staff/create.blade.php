                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <div class="buttonAlign d-flex justify-content-between">
                                    <h2 class="mb-1 page-title">Create New Staff</h2>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="employee_ID" placeholder="Employee ID"
                                                   value="{{ old('employee_ID') }}" class="form-control" required>
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="eme_phone" value="{{ old('eme_phone') }}"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control select2" name="roles" required>
                                                ...
                                                @foreach($role as $key => $r)
                                                    <option
                                                        value="{{ $r->id }}" {{ old('roles') == $r->id ? 'selected' : '' }}>{{ $r->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="form-group mb-3 custom-control custom-checkbox">
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="staff_i_card"
                                                               ...
                                                               {{ old('staff_i_card') == 'on' ? 'checked' : '' }} id="customCheck1">
                                                ...
                                                <div class="form-group mb-3 custom-control custom-checkbox">
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="staff_uniform"
                                                               class="custom-control-input"
                                                               {{ old('staff_uniform') == 'on' ? 'checked' : '' }} id="customCheck2">
