                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="hidden" readonly name="data[{{ $key }}][Staff_id]" value="{{ $s->id }}" class="form-control">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="data[{{ $key }}][attendance]" value="1">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="data[{{ $key }}][absent_reason]" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
