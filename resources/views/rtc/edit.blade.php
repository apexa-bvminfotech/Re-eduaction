        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="buttonAlign">
                    <h2 class="mb-2 page-title">Edit RTC</h2>
                ...
                <div class="card-deck col-6">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            {!! Form::model($rtc, ['method' => 'PATCH','route' => ['rtc.update', $rtc->id]]) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="address" placeholder="RTC Address" rows="2">{{ $rtc->address }}</textarea>
                                </div>
                            </div>
