                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        @if (in_array($t->id,$presentTrainerId) && in_array($regularStaff->slot->id,$presentSlotId) && in_array($regularStaff->student->id,$presentStudentId))
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input attendance-checkbox-present trainer-{{ $t->id }}" type="radio" name="attendance_details_{{ $t->id }}[slot_{{ $t->id }}_{{  $regularStaff->slot->id }}][student_details_regular][{{ $key }}][attendance_type]"
                                                                                    value="1" checked>
                                                                        ...
                                                                        @if (in_array($t->id,$absentTrainerId) && in_array($regularStaff->slot->id,$absentSlotId) && in_array($regularStaff->student->id,$absentStudentId))
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input attendance-checkbox-absent trainer-{{ $t->id }}" type="radio" name="attendance_details_{{ $t->id }}[slot_{{ $t->id }}_{{  $regularStaff->slot->id }}][student_details_regular][{{ $key }}][attendance_type]"
                                                                                    value="0" checked>
